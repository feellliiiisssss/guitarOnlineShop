...
<html lang="en">
  <head>
    ...
    <title>Cheetarr | Pedals-Accessories</title>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">EL CAPISTAN</a></h3>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">IRIDIUM</a></h3>
                    <div class="price">$100.00</div>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">TIMELINE STRYMON</a></h3>
                    <div class="price">$100.00</div>
                  </div>
                </div>
              </div>
