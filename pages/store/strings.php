            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">CLEARTONE ELECTRIC</a></h3>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">DEAN MARKLEY</a></h3>
                    <div class="price">$50.00</div>
                  </div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="product-grid5">
                  ...
                  <div class="product-content text-center">
                    <h3 class="title text-uppercase"><a href="#">ROUNDWOUND NICKEL</a></h3>
                    <div class="price">$50.00</div>
                  </div>
                </div>
              </div>
