...
<head>
  ...
  <title>Cheetarr | Straps-Accessories</title>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="product-grid5">
                ...
                <div class="product-content text-center">
                  <h3 class="title text-uppercase"><a href="#">CHOCOLATE STRAPS</a></h3>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="product-grid5">
                ...
                <div class="product-content text-center">
                  <h3 class="title text-uppercase"><a href="#">WALNUT STRAPS</a></h3>
                  <div class="price">$30.00</div>
                </div>
              </div>
            </div>
            <div class="col-md-3 col-sm-6">
              <div class="product-grid5">
                ...
                <div class="product-content text-center">
                  <h3 class="title text-uppercase"><a href="#">CREAM STRAPS</a></h3>
                  <div class="price">$30.00</div>
                </div>
              </div>
            </div>
