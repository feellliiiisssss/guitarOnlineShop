...
<body>
  ...
  <header id="header" class="fixed-top">
      ...
      <nav id="navbar" class="navbar mx-auto">
        <ul>
          ...
          <li class="dropdown"><a href="#acessories"><span>Accessories</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <section id="hero">
    <div class="hero-container mx-auto" data-aos="fade-up" data-aos-delay="150">
      ...
      <h2>We are prod of talented designers making websites with Bootstrap</h2>
      <div class="d-flex">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Wow! CHEETAAR is holding a 10% DISCOUNT PROMO! and only valid for two days, 19-20 June 2022!</p>
                <p class="excerpt">You can enter the promo code 10OFF in the coupon column when you want to check out your products</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Welcome to our new brand product, ALHAMBRA GUITARS! ADD TO CART FOR NEW EXPERIENCE!</p>
                <p class="excerpt">Established in 1965, with 50 years of experience in the construction of the best handmade classical, flamenco and steel string guitars in the world. </p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="excerpt">Pay Cheetarr Products by using the GoPay payment method for easier transactions. GoPay is electronic money that you can use to make payments and financial transactions</p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" style="height: 600px;">
          ...
          <div class="col d-inline-block h-100" style="width: 120px;" data-aos="fade-up" data-aos-delay="200">
            <div class="member" >
              <div class="pic"><img src="assets/img/akustik/gitar 1 pnjg.png" class="img-fluid" style="height: 460px;" alt=""></div>
            ...
            <div class="col d-inline-block h-100" style="width: 120px;" data-aos="fade-up" data-aos-delay="200">
              <div class="member">
                <div class="pic"><img src="assets/img/akustik/gitar 5 pnjg.png" class="img-fluid" style="height: 460px;" alt=""></div>
                <div class="thumb-content text-center">
          ...
          <div class="col d-inline-block h-100" style="width: 120px;"  data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src="assets/img/akustik/gitar 2 pnjg.png" class="img-fluid" style="height: 460px;" alt=""></div>
              <div class="thumb-content text-center">
          ...
          <div class="col d-inline-block h-100" style="width: 120px;" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
              <div class="pic"><img src="assets/img/akustik/gitar 3 pnjg.png" class="img-fluid" style="height: 460px; width: 190px;" alt=""></div>
              <div class="thumb-content text-center">
          ...
          <div class="col d-inline-block" style="width: 120px; height: 800px;" data-aos="fade-up" data-aos-delay="500">
            <div class="member">
              <div class="pic"><img src="assets/img/akustik/gitar 4 pnjg.png" class="img-fluid" style="height: 460px;" alt=""></div>
              <div class="thumb-content text-center">
          ...
          <div class="col d-inline-block" style="width: 120px; height: 800px;" data-aos="fade-up" data-aos-delay="500">
            <div class="member">
              <div class="pic"><img src="assets/img/elektrik/ele 1 pnjg.png" class="img-fluid" style="height: 460px;" alt=""></div>
              <div class="thumb-content text-center">
